...
from O2oUtility import AdminProviderPayOptionListFrame
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_provider_payOption_list_frame', 'API.webId', webId)
        
        self.res_log, result, payOptionId = AdminProviderPayOptionListFrame(self.res_log, 'Boss', payOptionName, 'Mobile')
