...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminProviderPayOptionEditGetWithdraw(self.res_log, 'Boss', paymentName, withdrawId)
        result_list.append(result)
        
        depositId = IniValue('setting', 'API.depositId')
        ReplaceIniValue('admin_provider_payOption_edit_get_withdraw', 'API.payOption', '2')
        self.res_log, result = AdminProviderPayOptionEditGetWithdraw(self.res_log, 'Boss', paymentName, depositId)
        result_list.append(result)
