...
from O2oUtility import AdminProviderPayOptionEditGetLayerFrame
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        payOptionName = IniValue('setting', 'API.payoptionname')+number
        payOptionId = IniValue('setting', 'API.payoptionid')
        vipId = IniValue('setting', 'API.vipid')
        
        self.res_log, result = AdminProviderPayOptionEditGetLayerFrame(self.res_log, 'Boss', payOptionName, payOptionId, vipId, 'Mobile')
