...
from O2oUtility import AdminVipGroupListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_list_frame', 'API.bankerId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_list_frame', 'API.bankerId', bankerId)
        self.res_log, result, vipGroupId = AdminVipGroupListFrame(self.res_log, 'Boss', vipGroupName, 'Mobile')
        
        if(result == True):
            ReplaceIniValue('setting', 'API.vipGroupId', vipGroupId)
