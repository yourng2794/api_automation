...
from O2oUtility import AdminVipGroupEdit
...
#         ReplaceIniValue('admin_webPlayer_vip_group_edit', 'API.vipGroupId', '')
#         ReplaceIniValue('admin_webPlayer_vip_group_edit', 'API.vipid[]', '')
#         ReplaceIniValue('admin_webPlayer_vip_group_edit', 'API.vipGroupName', '')
    ...
    def run(self, copy_result):
        ...
        vipGroupName = IniValue('setting', 'API.vipGroupName')+number
        ReplaceIniValue('admin_webPlayer_vip_group_edit', 'API.vipGroupId', vipGroupId)
        ReplaceIniValue('admin_webPlayer_vip_group_edit', 'API.vipid[]', vipId)
        ReplaceIniValue('admin_webPlayer_vip_group_edit', 'API.vipGroupName', 'new'+vipGroupName)
        ReplaceIniValue('admin_webPlayer_vip_group_edit', 'API.vipGroupName', vipGroupName)
        self.res_log, result = AdminVipGroupEdit(self.res_log, 'Boss')
