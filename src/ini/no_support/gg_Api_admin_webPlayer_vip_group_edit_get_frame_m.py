...
from O2oUtility import AdminVipGroupEditGetFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_edit_get_frame', 'API.vipGroupId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminVipGroupEditGetFrame(self.res_log, 'Boss', vipName, vipId, 'Mobile')
