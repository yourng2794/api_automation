...
from O2oUtility import AdminVipDomainGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_vip_domain_get', 'API.vipGroupId', '')
        ReplaceIniValue('admin_webPlayer_web_vip_domain_get', 'API.webId', '')
        ReplaceIniValue('admin_webPlayer_web_vip_domain_get', 'API.vipId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminVipDomainGet(self.res_log, 'Boss', webDomainId, webDomain, vipName, transferSet, setTime)
