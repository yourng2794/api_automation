...
from O2oUtility import AdminWebVipListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_vip_list_frame', 'API.webId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminWebVipListFrame(self.res_log, 'Boss', vipGroupName, transferSet, setTime, 'Mobile')
