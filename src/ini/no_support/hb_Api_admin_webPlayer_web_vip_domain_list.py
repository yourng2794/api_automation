...
from O2oUtility import AdminWebVipDomainList
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_vip_domain_list', 'API.webId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_vip_domain_list', 'API.webId', webId)
        
        self.res_log, result = AdminWebVipDomainList(self.res_log, 'Boss', webDomain, webdomainid)
