...
from O2oUtility import AdminWebVipGroupEditFrame
from O2oUtility import AdminWebVipDomainEdit
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_vip_group_edit_frame', 'API.webId', '')
        ReplaceIniValue('admin_webPlayer_web_vip_group_edit_frame', 'API.vipGroupId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_vip_group_edit_frame', 'API.webId', webId)
        ReplaceIniValue('admin_webPlayer_web_vip_group_edit_frame', 'API.vipGroupId', vipGroupId)
        
        self.res_log, result = AdminWebVipGroupEditFrame(self.res_log, 'Boss', vipId, vipName, webDomain, 'Mobile')
        ...
        self.res_log, result = AdminWebVipDomainEdit(self.res_log, 'Boss')
