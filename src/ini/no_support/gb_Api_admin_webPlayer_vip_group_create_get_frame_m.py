...
from O2oUtility import AdminVipGroupCreateGetFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create_get_frame', 'API.bankerId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create_get_frame', 'API.bankerId', bankerId)
        
        self.res_log, result = AdminVipGroupCreateGetFrame(self.res_log, 'Boss', vipName, vipId, 'Mobile')
