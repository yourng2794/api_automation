...
from O2oUtility import AdminWebListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_list_frame', 'API.WebMasterId', '')
        ReplaceIniValue('admin_webPlayer_web_list_frame', 'API.page', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_list_frame', 'API.WebMasterId', partnerId)
        
        self.res_log, result, webId = AdminWebListFrame(self.res_log, 'WebMaster', webName, 'Mobile')
