...
#         ReplaceIniValue('admin_webPlayer_domain_create', 'API.WebMasterId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_create', 'API.WebMasterId', partnerId)
        self.res_log, result = AdminDomainCreate(self.res_log, 'WebMaster', webDomain)
