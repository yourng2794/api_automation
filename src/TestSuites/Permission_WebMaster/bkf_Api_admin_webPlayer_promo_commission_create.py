...
from O2oUtility import AdminWebPromoCommissionCreate
...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST webPlayer promo commission create'
        self.CaseNote= ''
        self.TestCaseID= '622'
...
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.webId', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.vipId', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.webCommissionName', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.commissionTimes', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.receiveTimesDaily', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.totalBet', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.promotionLimit', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.maxReceiveAmount', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.singleMinReceiveAmount', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.fish', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.lived', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.lottery', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.poker', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.slot', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.sport', '')
#         ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.esport', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer promo commission create'+'\n')
        
        webId = IniValue('setting', 'API.webid')
        vipId = IniValue('setting', 'API.vipid')
        commissionName = IniValue('setting', 'API.commissionName')
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.webId', webId)
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.vipId', vipId)
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.webCommissionName', commissionName) # 範本名稱
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.commissionTimes', '200') # 打碼倍數
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.receiveTimesDaily', '5') # 每日領取次數
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.totalBet', '400') # 有效總投注
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.promotionLimit', '500') # 優惠上限
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.maxReceiveAmount', '600') # 單日最高領取金額
        ReplaceIniValue('admin_webPlayer_promo_commission_create', 'API.singleMinReceiveAmount', '100') # 單次最低領取金額
        self.res_log, result = AdminWebPromoCommissionCreate(self.res_log, 'WebMaster')
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer promo commission create')
