...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_list_frame', 'API.WebMasterId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_list_frame', 'API.WebMasterId', partnerid)
        
        self.res_log, result, vipGroupId = AdminVipGroupListFrame(self.res_log, 'WebMaster', vipGroupName, 'Mobile')
