...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_promo_list_frame', 'API.bankerId', partnerId)
        ...
        self.res_log, result, promoId= AdminWebPromoListFrame(self.res_log, 'WebMaster', webName, promoName, 'Mobile')
