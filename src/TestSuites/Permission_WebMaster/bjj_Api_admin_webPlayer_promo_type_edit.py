...
#         ReplaceIniValue('admin_webPlayer_promo_type_edit', 'API.reward', '')
    ...
    def run(self, copy_result):
        ...
        condition = IniValue('admin_webPlayer_promo_type_create', 'API.condition')
        reward = IniValue('admin_webPlayer_promo_type_create', 'API.reward')
        ...
        ReplaceIniValue('admin_webPlayer_promo_type_edit', 'API.reward', reward)
        
        self.res_log, result= AdminWebPromoTypeEdit(self.res_log, 'WebMaster')
