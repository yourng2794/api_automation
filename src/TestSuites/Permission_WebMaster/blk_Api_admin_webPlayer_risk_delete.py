...
from O2oUtility import AdminWebRiskDelete
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_risk_delete', 'API.riskid', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_risk_delete', 'API.riskid', riskid)
        
        self.res_log, result= AdminWebRiskDelete(self.res_log, 'WebMaster')
