...
#         ReplaceIniValue('admin_webPlayer_vip_create', 'API.WebMasterId', '')
...
#         ReplaceIniValue('admin_webPlayer_vip_create', 'API.maxDepositAmount', '')
#         ReplaceIniValue('admin_webPlayer_vip_create', 'API.maxWithdrawalAmount', '')
#         ReplaceIniValue('admin_webPlayer_vip_create', 'API.withdrawalTimes', '')
#         ReplaceIniValue('admin_webPlayer_vip_create', 'API.withdrawalTotal', '')
