...
from O2oUtility import AdminWebTransferListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_transfer_list_frame', 'API.webId', '')
        ReplaceIniValue('admin_webPlayer_transfer_list_frame', 'API.vipId', '')
        ReplaceIniValue('admin_webPlayer_transfer_list_frame', 'API.playerAcc', '')
        ReplaceIniValue('admin_webPlayer_transfer_list_frame', 'API.page', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminWebTransferListFrame(self.res_log, 'WebMaster', playerAcc, playerId, 'Mobile')
