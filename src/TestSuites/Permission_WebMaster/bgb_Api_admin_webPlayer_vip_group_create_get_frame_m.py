...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create_get_frame', 'API.WebMasterId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create_get_frame', 'API.WebMasterId', partnerid)
        
        self.res_log, result = AdminVipGroupCreateGetFrame(self.res_log, 'WebMaster', vipName, vipId, 'Mobile')
