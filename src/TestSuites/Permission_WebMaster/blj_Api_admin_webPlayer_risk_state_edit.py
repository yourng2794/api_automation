...
from O2oUtility import AdminWebRiskStateEdit
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_risk_state_edit', 'API.riskid', '')
        ReplaceIniValue('admin_webPlayer_risk_state_edit', 'API.enable', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminWebRiskStateEdit(self.res_log, 'WebMaster', '停止')
        ...
        ReplaceIniValue('admin_webPlayer_risk_state_edit', 'API.enable', '1')
        self.res_log, result = AdminWebRiskStateEdit(self.res_log, 'WebMaster', '监控中')
