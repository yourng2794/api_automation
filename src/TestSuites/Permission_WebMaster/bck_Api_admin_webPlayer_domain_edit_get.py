...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_domain_edit_get', 'API.WebMasterId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_edit_get', 'API.WebMasterId', partnerId)
        
        self.res_log, result = AdminDomainEditGet(self.res_log, 'WebMaster', WebMasterAcc)
