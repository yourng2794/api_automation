...
from O2oUtility import AdminWebRiskWebFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_risk_web_frame', 'API.riskid', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_risk_web_frame', 'API.ptid', partnerId)
        ReplaceIniValue('admin_webPlayer_risk_web_frame', 'API.riskid', riskId)
        
        self.res_log, result = AdminWebRiskWebFrame(self.res_log, 'WebMaster', webName, webId, 'Mobile')
