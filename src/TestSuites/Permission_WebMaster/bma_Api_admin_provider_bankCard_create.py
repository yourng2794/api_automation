...
from O2oUtility import AdminProviderBankCardCreate
...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST provider bankCard create'
        self.CaseNote= ''
        self.TestCaseID= '128'
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_provider_bankCard_create', 'API.bankerId', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.bankName', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.branchName', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.bankAcc', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.accName', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.currency', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.amount', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.maxwithdraw', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.maxdeposit', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.mindeposit', '')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.option', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST provider bankCard create'+'\n')
        
        bankname = IniValue('setting', 'API.bankname')
        branchname = IniValue('setting', 'API.branchname')
        bankacc = IniValue('setting', 'API.bankacc')
        bankaccname = IniValue('setting', 'API.bankaccname')
        partnerid = IniValue('setting', 'API.partnerid')
        currency = IniValue('setting', 'API.currency')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.bankerId', partnerid)
        ReplaceIniValue('admin_provider_bankCard_create', 'API.bankName', bankname)
        ReplaceIniValue('admin_provider_bankCard_create', 'API.branchName', branchname)
        ReplaceIniValue('admin_provider_bankCard_create', 'API.bankAcc', bankacc)
        ReplaceIniValue('admin_provider_bankCard_create', 'API.accName', bankaccname)
        ReplaceIniValue('admin_provider_bankCard_create', 'API.currency', currency)
        ReplaceIniValue('admin_provider_bankCard_create', 'API.amount', '5000')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.maxwithdraw', '3000')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.maxdeposit', '1000')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.mindeposit', '100')
        ReplaceIniValue('admin_provider_bankCard_create', 'API.option', '3')

        self.res_log, result = AdminProviderBankCardCreate(self.res_log, 'WebMaster')
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST provider bankCard create')
