...
from O2oUtility import AdminWebEdit
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_edit', 'API.WebMasterId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_edit', 'API.WebMasterId', partnerId)
        ReplaceIniValue('admin_webPlayer_web_edit', 'API.use', '3')
        python_dict = {}
        python_dict[webDomainId] = '1'
        ...
        ReplaceIniValue('admin_webPlayer_web_edit', 'API.webId', webId)
            
        self.res_log, result = AdminWebEdit(self.res_log, 'WebMaster')
