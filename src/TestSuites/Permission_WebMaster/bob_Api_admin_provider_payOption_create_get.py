...
from O2oUtility import AdminProviderPayOptionCreateGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_provider_payOption_create_get', 'API.webId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_provider_payOption_create_get', 'API.webId', webId)
        
        self.res_log, result = AdminProviderPayOptionCreateGet(self.res_log, 'WebMaster')
