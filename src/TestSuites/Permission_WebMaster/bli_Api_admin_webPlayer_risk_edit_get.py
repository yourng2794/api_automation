...
from O2oUtility import AdminWebRiskEditGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_risk_edit_get', 'API.riskid', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_risk_edit_get', 'API.ptid', partnerid)
        ...
        self.res_log, result = AdminWebRiskEditGet(self.res_log, 'WebMaster', riskname, riskid, edit_count, edit_interval, edit_time, edit_type)
