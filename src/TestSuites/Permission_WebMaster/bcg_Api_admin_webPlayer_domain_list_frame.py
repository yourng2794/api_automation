...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_domain_list_frame', 'API.WebMasterid', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_list_frame', 'API.WebMasterid', partnerId)
        self.res_log, result, webdomainid = AdminDomainListFrame(self.res_log, 'WebMaster', '', '', 'Web')
