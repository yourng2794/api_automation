...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_promo_type_list_frame', 'API.bankerId', partnerId)
        ReplaceIniValue('admin_webPlayer_promo_type_list_frame', 'API.page', '')
        
        self.res_log, result, promoTypeId = AdminWebPromoTypeListFrame(self.res_log, 'WebMaster', promoTypeName, 'Mobile')
