...
from O2oUtility import AdminOrgJobtitleDelete
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_jobtitle_delete', 'API.titleId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_jobtitle_delete', 'API.titleId', depTitleId)
        
        self.res_log, result = AdminOrgJobtitleDelete(self.res_log, 'WebMaster')
