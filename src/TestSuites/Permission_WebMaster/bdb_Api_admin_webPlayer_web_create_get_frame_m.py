...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_create_get_frame', 'API.WebMasterId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_create_get_frame', 'API.WebMasterId', partnerId)
        
        self.res_log, result = AdminWebCreateGetFrame(self.res_log, 'WebMaster', webDomain, webDomainId, 'Mobile')
