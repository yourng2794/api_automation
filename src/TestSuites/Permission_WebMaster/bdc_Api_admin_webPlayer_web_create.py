...
from O2oUtility import AdminWebCreate
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_create', 'API.WebMasterId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_create', 'API.WebMasterId', partnerId)
        python_dict = {}
        python_dict[webdomainId] = '1'
        ReplaceIniValue('admin_webPlayer_web_create', 'API.webdomainId', str(python_dict).replace("'",'"').replace(' ',''))
        ReplaceIniValue('admin_webPlayer_web_create', 'API.webName', webName)
        
        self.res_log, result = AdminWebCreate(self.res_log, 'WebMaster')
