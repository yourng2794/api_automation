...
from O2oUtility import AdminProviderBankCardEditGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_provider_bankCard_edit_get', 'API.cardId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_provider_bankCard_edit_get', 'API.cardId', cardId)
        amount = '5000'
        maxwithdraw = '3000'
        maxdeposit = '1000'
        mindeposit = '100'
        ...
        self.res_log, result = AdminProviderBankCardEditGet(self.res_log, 'WebMaster', amount, maxwithdraw, maxdeposit, mindeposit, bankname, branchname, bankacc, bankaccname)
