...
from O2oUtility import AdminWebRiskRuleFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_risk_rule_frame', 'API.riskid', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_risk_rule_frame', 'API.ptid', partnerid)
        ...
        self.res_log, result = AdminWebRiskRuleFrame(self.res_log, 'WebMaster', opt_interval, opt_count, 'Mobile')
