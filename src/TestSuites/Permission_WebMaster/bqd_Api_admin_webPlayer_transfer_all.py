...
from O2oUtility import AdminWebTransferAll
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_transfer_all', 'API.webId', '')
        ReplaceIniValue('admin_webPlayer_transfer_all', 'API.vipId', '')
        ReplaceIniValue('admin_webPlayer_transfer_all', 'API.outVipId', '')
        ReplaceIniValue('admin_webPlayer_transfer_all', 'API.playerAcc', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminWebTransferAll(self.res_log, 'WebMaster')
