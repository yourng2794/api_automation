...
from O2oUtility import AdminWebTransfer
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_transfer', 'API.webId', '')
        ReplaceIniValue('admin_webPlayer_transfer', 'API.playerId[]', '')
        ReplaceIniValue('admin_webPlayer_transfer', 'API.outVipId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminWebTransfer(self.res_log, 'WebMaster')
