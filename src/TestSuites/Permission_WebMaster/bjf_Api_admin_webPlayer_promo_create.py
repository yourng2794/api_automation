...
#         ReplaceIniValue('admin_webPlayer_promo_create', 'API.reward', '')
#         ReplaceIniValue('admin_webPlayer_promo_create', 'API.startTime', '')
#         ReplaceIniValue('admin_webPlayer_promo_create', 'API.endTime', '')
    ...
    def run(self, copy_result):
        ...
        time = str(start_time.strftime("%Y-%m-%d %H:%M:%S"))+' ~ '+str(end_time.strftime("%Y-%m-%d %H:%M:%S"))
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.time', time)
        
        self.res_log, result= AdminWebPromoCreate(self.res_log, 'WebMaster')
