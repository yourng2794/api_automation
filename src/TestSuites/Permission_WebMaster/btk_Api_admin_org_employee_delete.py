...
from O2oUtility import AdminOrgEmployeeDelete
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_employee_delete', 'API.userId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_employee_delete', 'API.userId', userId)
        
        self.res_log, result = AdminOrgEmployeeDelete(self.res_log, 'WebMaster')
