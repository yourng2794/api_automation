...
from O2oUtility import AdminProviderPayOptionEditLayer
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_provider_payOption_edit_layer', 'API.bankerId', partnerId)
        python_dict = {}
        ...
        self.res_log, result = AdminProviderPayOptionEditLayer(self.res_log, 'WebMaster')
