...
from O2oUtility import AdminVipEdit
...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST webPlayer vip edit'
        self.CaseNote= ''
        self.TestCaseID= '86'
...
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.WebMasterId', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipname', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipId', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.depositTimes', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.depositTotal', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.maxDepositAmount', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.maxWithdrawalAmount', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.withdrawalTimes', '')
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.withdrawalTotal', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer vip edit'+'\n')
        partnerid = IniValue('setting', 'API.partnerid')
        vipname = IniValue('setting', 'API.vipname')
        vipid = IniValue('setting', 'API.vipid')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.WebMasterId', partnerid)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipname', vipname)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipId', vipid)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.deposittimes', '10')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.deposittotal', '')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.maxdepositamount', '2000')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.maxwithdrawalamount', '1000')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.withdrawaltimes', '10')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.withdrawaltotal', '100')
        
        self.res_log, result = AdminVipEdit(self.res_log, 'WebMaster')
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer vip edit')
