...
from O2oUtility import AdminOrgJobtitlePermission
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_jobtitle_permission', 'API.depId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_jobtitle_permission', 'API.depId', depId)
        
        self.res_log, result = AdminOrgJobtitlePermission(self.res_log, 'WebMaster')
