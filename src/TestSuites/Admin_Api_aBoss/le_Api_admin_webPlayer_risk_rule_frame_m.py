...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_risk_rule_frame', 'API.ptid', bankerId)
        ...
        self.res_log, result = AdminWebRiskRuleFrame(self.res_log, 'Boss', opt_interval, opt_count, 'Mobile')
