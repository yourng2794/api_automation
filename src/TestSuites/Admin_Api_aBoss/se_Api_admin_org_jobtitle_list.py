...
from O2oUtility import AdminOrgJobtitleList
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_jobtitle_list', 'API.depId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_jobtitle_list', 'API.depId', depId)
        
        self.res_log, result = AdminOrgJobtitleList(self.res_log, 'Boss', depTitle, depTitleId)
