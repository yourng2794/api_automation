...
from O2oUtility import AdminOrgDeptEdit
...
#         ReplaceIniValue('admin_org_dept_edit', 'API.depId', '')
#         ReplaceIniValue('admin_org_dept_edit', 'API.name', '')
#         ReplaceIniValue('admin_org_dept_edit', 'API.descrip', '')
#         ReplaceIniValue('admin_org_dept_edit', 'API.permission', '{}')
    ...
    def run(self, copy_result):
        ...
        depname = IniValue('setting', 'API.depname')+number
        desc = IniValue('setting', 'API.myname')+number
        ReplaceIniValue('admin_org_dept_edit', 'API.depId', depId)
        ReplaceIniValue('admin_org_dept_edit', 'API.name', depname)
        ReplaceIniValue('admin_org_dept_edit', 'API.descrip', desc)
        
        self.res_log, result = AdminOrgDeptEdit(self.res_log, 'Boss')
