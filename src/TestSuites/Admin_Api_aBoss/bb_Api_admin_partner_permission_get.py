...
from O2oUtility import AdminPartnerPermissionGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_partner_permission_get', 'API.ptParentId', '')
    ...
    def run(self, copy_result):
        ...
        bankerTypeName = IniValue('setting', 'API.bankerTypeName')
#         ReplaceIniValue('admin_partner_permission_get', 'API.ptParentId', partnerId)
        webId = 'False'
        ReplaceIniValue('admin_partner_permission_get', 'API.ptParentId', '')
        self.res_log, result, str_currency, str_permission_final, bankerTypeId = AdminPartnerPermissionGet(self.res_log, 'Initial', webId, bankerTypeName)
        
        if(result == True):
            ReplaceIniValue('setting', 'API.bankerTypeId', bankerTypeId)
            ReplaceIniValue('admin_partner_create', 'API.currency[]', str_currency)
            ReplaceIniValue('admin_partner_create', 'API.permission', str_permission_final)
#             ReplaceIniValue('admin_partner_edit', 'API.currency[]', str_currency)
#             ReplaceIniValue('admin_partner_edit', 'API.permission', str_permission_final)
#             ReplaceIniValue('admin_partner_type_create', 'API.currency[]', str_currency)
#             ReplaceIniValue('admin_partner_type_create', 'API.permission', str_permission_final)
#             ReplaceIniValue('admin_partner_type_edit', 'API.currency[]', str_currency)
#             ReplaceIniValue('admin_partner_type_edit', 'API.permission', str_permission_final)
