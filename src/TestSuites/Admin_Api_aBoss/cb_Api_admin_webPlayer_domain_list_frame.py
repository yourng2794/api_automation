...
from O2oUtility import AdminDomainListFrame
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, webdomainid = AdminDomainListFrame(self.res_log, 'Boss', '', '', 'Web')
        
        if(result == True):
            ReplaceIniValue('setting', 'API.webdomainid', webdomainid)
