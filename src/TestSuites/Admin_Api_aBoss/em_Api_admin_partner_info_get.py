...
from O2oUtility import AdminPartnerInfoGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_partner_info_get', 'API.ptId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_partner_info_get', 'API.ptId', webmasterId)
        acc = IniValue('setting', 'API.webmasteracc')+number
        webId = IniValue('setting', 'API.webid')
        webmaster_percent = IniValue('setting', 'API.webmaster_percent')
        
        self.res_log, result = AdminPartnerInfoGet(self.res_log, 'Boss', webmasterId, acc, webId, webmaster_percent)
