...
from O2oUtility import AdminWebPromoTypeCreateFriend
...
#         ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.reward', '')
    ...
    def run(self, copy_result):
        ...
        promoTypeName = 'QA好友範本'+number
#         promoTypeName = promoTypeName+today_time.strftime("%m%d_%H%M%S")
        ReplaceIniValue('setting', 'API.promoTypeName4', promoTypeName)
        bankerId = IniValue('setting', 'API.bankerId')
        condition4 = IniValue('setting', 'API.condition4')
        ReplaceIniValue('admin_webPlayer_promo_type_create_friend', 'API.promoName', promoTypeName)
        ReplaceIniValue('admin_webPlayer_promo_type_create_friend', 'API.bankerId', bankerId)
        ReplaceIniValue('admin_webPlayer_promo_type_create_friend', 'API.promoType', '4')
        ReplaceIniValue('admin_webPlayer_promo_type_create_friend', 'API.promoAudit', '10.00')
        ReplaceIniValue('admin_webPlayer_promo_type_create_friend', 'API.condition', condition4)
        
        self.res_log, result = AdminWebPromoTypeCreateFriend(self.res_log, 'Boss')
