...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        print_tab = '\n\t\t'
        try:
            ReplaceIniValue('admin_provider_content_list_frame', 'API.lang', 'zh')
            
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_provider_content_list_frame', False, False)
            ...
            result_list.append('FAIL')
            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Exception: on admin_provider_content_list_frame... %s' % str(e))
