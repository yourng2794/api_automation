...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_promo_commission_create_get', 'API.bankerId', bankerId)
        
        self.res_log, result = AdminWebPromoCommissionCreateGet(self.res_log, 'Boss', commissionTypeName, commissionTypeId)
