...
from O2oUtility import AdminWebEditGetFrame
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_edit_get_frame', 'API.webId', webId)
        ReplaceIniValue('admin_webPlayer_web_edit_get_frame', 'API.bankerId', bankerId)
        
        self.res_log, result = AdminWebEditGetFrame(self.res_log, 'Boss', webDomain, webDomainId, web_or_mobile = 'Mobile')
