...
from O2oUtility import AdminOrgEmployeeListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_employee_list_frame', 'API.depId', '')
        ReplaceIniValue('admin_org_employee_list_frame', 'API.titleId', '')
        ReplaceIniValue('admin_org_employee_list_frame', 'API.userAcc', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_employee_list_frame', 'API.depId', depId)
        ReplaceIniValue('admin_org_employee_list_frame', 'API.titleId', titleId)
        ReplaceIniValue('admin_org_employee_list_frame', 'API.userAcc', userAcc)
        
        self.res_log, result, userId = AdminOrgEmployeeListFrame(self.res_log, 'Boss', 'Mobile')
        
        if(result == True):
            ReplaceIniValue('setting', 'API.userid', userId)
