...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_provider_bankCard_list_frame', 'API.bankerId', bankerId)
        ReplaceIniValue('admin_provider_bankCard_list_frame', 'API.option', '0')
        ReplaceIniValue('admin_provider_bankCard_list_frame', 'API.enable', '3')
        ReplaceIniValue('admin_provider_bankCard_list_frame', 'API.page', '')
        
        self.res_log, result, cardId = AdminProviderBankCardListFrame(self.res_log, 'Boss', bankName, 'Mobile')
