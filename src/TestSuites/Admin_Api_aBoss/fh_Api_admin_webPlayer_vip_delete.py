...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        str_webDomain = IniValue('setting', 'API.webDomain')
        webDomain = str_webDomain.split(', ')[0]+number
        webId = IniValue('setting', 'API.webId')
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.webId', webId)
        ...
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.webDomainId', webDomainId)
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.webDomainUrl', webDomain)
        
        self.res_log, result = AdminVipCreate(self.res_log, 'Boss')
        result_list.append(result)
        
        # Part 2: Get VIP ID from web.
        ReplaceIniValue('admin_webPlayer_vip_list_frame', 'API.webId', webId)
        ReplaceIniValue('admin_webPlayer_vip_list_frame', 'API.bankerId', bankerId)
        
        self.res_log, result, vipId = AdminVipListFrame(self.res_log, 'Boss', vipname, 'Web')
        result_list.append(result)
        
        # Part 3: Get VIP ID from mobile web.
        
        # Part 4: Delete VIP.
        ReplaceIniValue('admin_webPlayer_vip_delete', 'API.webId', webId)
        ReplaceIniValue('admin_webPlayer_vip_delete', 'API.vipId', vipId)
        self.res_log, result = AdminVipDelete(self.res_log, 'Boss')
        result_list.append(result)
