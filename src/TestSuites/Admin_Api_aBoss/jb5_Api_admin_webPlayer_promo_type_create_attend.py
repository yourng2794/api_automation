...
#         ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.reward', '')
    ...
    def run(self, copy_result):
        ...
        promoTypeName = 'QA簽到範本'+number
#         promoTypeName = promoTypeName+today_time.strftime("%m%d_%H%M%S")
        ReplaceIniValue('setting', 'API.promoTypeName5', promoTypeName)
        ...
        ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.promoType', '5')
        ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.promoAudit', '10.00')
        ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.condition', condition5) 
