...
#         ReplaceIniValue('admin_webPlayer_promo_create', 'API.condition', '')
    ...
    def run(self, copy_result):
        ...
        promoName = IniValue('setting', 'API.promoname')+'救援'
        ...
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.promoType', '3') # 1 normal, 2 birth, 3 save, 4 friend, 5 attend
        ...
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.condition', condition3) # 4 Change to save format 救援金派發時間=>sendTime,派發上限=>sendMax,派發下限=>sendMin
