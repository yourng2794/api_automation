...
from O2oUtility import AdminPartnerTypeCreate
...
#         ReplaceIniValue('admin_partner_type_create', 'API.handicap', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_partner_type_create', 'API.typeName', typeName)
        
        self.res_log, result = AdminPartnerTypeCreate(self.res_log, 'Boss')
        time.sleep(10)
        if(result == True):
