...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webId', webId)
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webDomainId', webDomainId)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webDomainUrl', webDomain)
        
        self.res_log, result = AdminVipEdit(self.res_log, 'Boss')
