...
#         ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.reward', '')
    ...
    def run(self, copy_result):
        ...
        promoTypeName = 'QA救援範本'+number
#         promoTypeName = promoTypeName+today_time.strftime("%m%d_%H%M%S")
        ReplaceIniValue('setting', 'API.promoTypeName3', promoTypeName)
        ...
        ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.promoType', '3')
        ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.promoAudit', '10.00')
        ReplaceIniValue('admin_webPlayer_promo_type_create', 'API.condition', condition3)
