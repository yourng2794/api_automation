...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit_get', 'API.webId', webId)
        ReplaceIniValue('admin_webPlayer_vip_edit_get', 'API.vipId', vipId)
        deposit_times = 'None'
        deposit_total = '1000'
        
        self.res_log, result = AdminVipEditGet(self.res_log, 'Boss', webName, vipId, webdomainId, deposit_times, deposit_total)
