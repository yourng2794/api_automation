...
from O2oUtility import AdminOrgDeptListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_dept_list_frame', 'API.page', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, depId = AdminOrgDeptListFrame(self.res_log, 'Boss', depname, 'Mobile')
