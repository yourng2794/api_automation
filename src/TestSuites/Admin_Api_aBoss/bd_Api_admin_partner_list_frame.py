...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_partner_list_frame', 'API.search', banker_acc)
        ReplaceIniValue('admin_partner_list_frame', 'API.listType', '')
        ReplaceIniValue('admin_partner_list_frame', 'API.page', '')
        self.res_log, result, bankerId = AdminPartnerListFrame(self.res_log, 'Boss', banker_acc, 'Web')
        
        if(result == True):
            ReplaceIniValue('setting', 'API.bankerId', bankerId)
