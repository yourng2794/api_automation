...
from O2oUtility import AdminPartnerTypeDelete
...
class TestCase(BaseCase):
    ...
    def __init__(self,MyTest):
        ...
        self.CaseTitle= '[Feature] API POST partner type delete'
        self.CaseNote= ''
        self.TestCaseID= '573'
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_partner_type_delete', 'API.typeId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminPartnerTypeDelete(self.res_log, 'Boss')
