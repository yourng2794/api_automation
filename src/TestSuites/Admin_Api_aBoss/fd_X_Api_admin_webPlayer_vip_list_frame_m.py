...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_list_frame', 'API.webId', '')
        ReplaceIniValue('admin_webPlayer_vip_list_frame', 'API.bankerId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, vipId = AdminVipListFrame(self.res_log, 'Boss', vipname, 'Mobile')
        
        if(result == True):
            ReplaceIniValue('setting', 'API.vipid', vipId)
