...
from O2oUtility import AdminOrgDeptLoadEdit
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_dept_load_edit', 'API.depId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_dept_load_edit', 'API.depId', depId)
        
        self.res_log, result = AdminOrgDeptLoadEdit(self.res_log, 'Boss', depname)
