...
from O2oUtility import AdminDomainEdit
...
#         ReplaceIniValue('admin_webPlayer_domain_edit', 'API.status', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_edit', 'API.webDomainId', webDomainId)
        ReplaceIniValue('admin_webPlayer_domain_edit', 'API.webDomain', webDomain)
        ReplaceIniValue('admin_webPlayer_domain_edit', 'API.status', '0')
        self.res_log, result = AdminDomainEdit(self.res_log, 'Boss')
