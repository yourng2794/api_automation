...
from O2oUtility import AdminProviderPaymentListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.webId', '')
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.option', '')
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.enable', '')
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.page', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.webId', webId)
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.option', '3')
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.enable', '1')
        ReplaceIniValue('admin_provider_payment_list_frame', 'API.page', '')
        
        self.res_log, result, paymentId = AdminProviderPaymentListFrame(self.res_log, 'Boss', paymentName, webName, 'Mobile')
