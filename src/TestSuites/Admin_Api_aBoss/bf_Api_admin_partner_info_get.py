...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_partner_info_get', 'API.ptId', bankerid)
        number = IniValue('setting', 'API.number')
        acc = IniValue('setting', 'API.bankeracc')+number
        webId = ''
        
        self.res_log, result = AdminPartnerInfoGet(self.res_log, 'Initial', bankerid, acc, webId, banker_percent)
