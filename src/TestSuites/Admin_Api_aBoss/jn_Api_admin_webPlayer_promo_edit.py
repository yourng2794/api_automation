...
#         ReplaceIniValue('admin_webPlayer_promo_edit', 'API.reward', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_promo_edit', 'API.rewards', '10.00')
        ReplaceIniValue('admin_webPlayer_promo_edit', 'API.vipId[]', vipId)
        ReplaceIniValue('admin_webPlayer_promo_edit', 'API.promoType', '1')
        ReplaceIniValue('admin_webPlayer_promo_edit', 'API.promoAudit', '10')
        start_time = now_time- timedelta(hours=24)
        newtime = str(start_time.strftime("%Y-%m-%d"))+' ~ '+str(end_time.strftime("%Y-%m-%d"))
        ReplaceIniValue('admin_webPlayer_promo_edit', 'API.time', newtime)
        
        self.res_log, result = AdminWebPromoEdit(self.res_log, 'Boss')
