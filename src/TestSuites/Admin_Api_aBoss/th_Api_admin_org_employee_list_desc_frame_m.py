...
from O2oUtility import AdminOrgEmployeeListDescFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_employee_list_desc_frame', 'API.depId', '')
        ReplaceIniValue('admin_org_employee_list_desc_frame', 'API.titleId', '')
        ReplaceIniValue('admin_org_employee_list_desc_frame', 'API.userAcc', '')
    ...
    def run(self, copy_result):
        ...
        userId = IniValue('setting', 'API.userid')
        userAcc = IniValue('setting', 'API.employeeacc1')+number
        ReplaceIniValue('admin_org_employee_list_desc_frame', 'API.depId', depId)
        ReplaceIniValue('admin_org_employee_list_desc_frame', 'API.titleId', titleId)
        ReplaceIniValue('admin_org_employee_list_desc_frame', 'API.userAcc', userAcc)
        
        self.res_log, result = AdminOrgEmployeeListDescFrame(self.res_log, 'Boss', userId, 'Mobile')
