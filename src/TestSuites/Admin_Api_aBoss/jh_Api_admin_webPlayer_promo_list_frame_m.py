...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, promoId= AdminWebPromoListFrame(self.res_log, 'Boss', webName, promoName, 'Mobile')
        
        promoName2 = IniValue('setting', 'API.promoName')+'生日'
        ReplaceIniValue('admin_webPlayer_promo_list_frame', 'API.promoType', '2')
        self.res_log, result2, promoId2= AdminWebPromoListFrame(self.res_log, 'Boss', webName, promoName2, 'Mobile')
        
        promoName3 = IniValue('setting', 'API.promoName')+'救援'
        ReplaceIniValue('admin_webPlayer_promo_list_frame', 'API.promoType', '3')
        self.res_log, result3, promoId3= AdminWebPromoListFrame(self.res_log, 'Boss', webName, promoName3, 'Mobile')
        
        promoName4 = IniValue('setting', 'API.promoName')+'好友'
        ReplaceIniValue('admin_webPlayer_promo_list_frame', 'API.promoType', '4')
        self.res_log, result4, promoId4= AdminWebPromoListFrame(self.res_log, 'Boss', webName, promoName4, 'Mobile')
        
        promoName5 = IniValue('setting', 'API.promoName')+'簽到'
        ReplaceIniValue('admin_webPlayer_promo_list_frame', 'API.promoType', '5')
        self.res_log, result5, promoId5= AdminWebPromoListFrame(self.res_log, 'Boss', webName, promoName5, 'Mobile')
