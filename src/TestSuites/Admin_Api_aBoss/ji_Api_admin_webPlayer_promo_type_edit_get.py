...
from O2oUtility import AdminWebPromoTypeEditGet
...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST webPlayer promo type edit get'
        self.CaseNote= ''
        self.TestCaseID= '114'
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_promo_type_edit_get', 'API.promoTypeId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer promo type edit get'+'\n')
        list_result = []
        
        promoTypeId = IniValue('setting', 'API.promoTypeId')
        promoTypeName = IniValue('setting', 'API.promoTypeName')
        str_conditions = IniValue('setting', 'API.condition')
        ReplaceIniValue('admin_webPlayer_promo_type_edit_get', 'API.promoTypeId', promoTypeId)
        
        self.res_log, result= AdminWebPromoTypeEditGet(self.res_log, 'Boss', 1, promoTypeName, promoTypeId, str_conditions)
        
        promoTypeId2 = IniValue('setting', 'API.promoTypeId2')
        promoTypeName2 = IniValue('setting', 'API.promoTypeName2')
        str_conditions2 = IniValue('setting', 'API.condition2')
        ReplaceIniValue('admin_webPlayer_promo_type_edit_get', 'API.promoTypeId', promoTypeId2)
        
        self.res_log, result2= AdminWebPromoTypeEditGet(self.res_log, 'Boss', 2, promoTypeName2, promoTypeId2, str_conditions2)
        
        promoTypeId3 = IniValue('setting', 'API.promoTypeId3')
        promoTypeName3 = IniValue('setting', 'API.promoTypeName3')
        str_conditions3 = IniValue('setting', 'API.condition3')
        ReplaceIniValue('admin_webPlayer_promo_type_edit_get', 'API.promoTypeId', promoTypeId3)
        
        self.res_log, result3= AdminWebPromoTypeEditGet(self.res_log, 'Boss', 3, promoTypeName3, promoTypeId3, str_conditions3)
        
        promoTypeId4 = IniValue('setting', 'API.promoTypeId4')
        promoTypeName4 = IniValue('setting', 'API.promoTypeName4')
        str_conditions4 = IniValue('setting', 'API.condition4')
        ReplaceIniValue('admin_webPlayer_promo_type_edit_get', 'API.promoTypeId', promoTypeId4)
        
        self.res_log, result4= AdminWebPromoTypeEditGet(self.res_log, 'Boss', 4, promoTypeName4, promoTypeId4, str_conditions4)
        
        promoTypeId5 = IniValue('setting', 'API.promoTypeId5')
        promoTypeName5 = IniValue('setting', 'API.promoTypeName5')
        str_conditions5 = IniValue('setting', 'API.condition5')
        ReplaceIniValue('admin_webPlayer_promo_type_edit_get', 'API.promoTypeId', promoTypeId5)
        
        self.res_log, result5= AdminWebPromoTypeEditGet(self.res_log, 'Boss', 5, promoTypeName5, promoTypeId5, str_conditions5)
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer promo type edit get')
