...
from O2oUtility import AdminWebPromoCreateFriend
...
#         ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.promoName', '')
#         ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.webId', '')
#         ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.vipId[]', '')
#         ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.promoType', '')
#         ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.promoAudit', '')
#         ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.condition', '') 
    ...
    def run(self, copy_result):
        ...
        promoName = IniValue('setting', 'API.promoname')+'好友'
        webId = IniValue('setting', 'API.webid')
        vipId = IniValue('setting', 'API.vipid')
        condition4 = IniValue('setting', 'API.condition4')
        ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.promoName', promoName)
        ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.webId', webId)
        ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.vipId[]', vipId)
        ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.promoType', '4') # 1 normal, 2 birth, 3 save, 4 friend, 5 attend
        ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.promoAudit', '10') # 2 multiple bet
        ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.condition', condition4) # 4 Change to friend format 累計推薦人數=>countNumbers,累計被推薦人存款金額=>countDepositAmount,達到後可領取=>receiveAmount
        ...
        ReplaceIniValue('admin_webPlayer_promo_create_friend', 'API.time', time)
        
        self.res_log, result= AdminWebPromoCreateFriend(self.res_log, 'Boss')
