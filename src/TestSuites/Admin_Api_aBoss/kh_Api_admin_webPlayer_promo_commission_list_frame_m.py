...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_promo_commission_list_frame', 'API.bankerId', bankerId)
        ...
        self.res_log, result = AdminWebPromoCommissionListFrame(self.res_log, 'Boss', webCommissionName, 'Mobile')
