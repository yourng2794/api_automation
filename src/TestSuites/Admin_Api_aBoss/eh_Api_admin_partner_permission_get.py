...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_partner_permission_get', 'API.ptParentId', bankerId)
        
        self.res_log, result, str_currency, str_permission_final, typeId = AdminPartnerPermissionGet(self.res_log, 'Boss', webId, typeName)
