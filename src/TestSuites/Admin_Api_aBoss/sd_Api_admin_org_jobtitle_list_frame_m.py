...
from O2oUtility import AdminOrgJobtitleListFrame
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_jobtitle_list_frame', 'API.depId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_jobtitle_list_frame', 'API.depId', depId)
        
        self.res_log, result, depTitleId = AdminOrgJobtitleListFrame(self.res_log, 'Boss', depTitle, 'Mobile')
