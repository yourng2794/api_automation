...
#         ReplaceIniValue('admin_webPlayer_promo_create', 'API.rewards', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.promoType', '1') # 1 normal, 2 birth, 3 save, 4 friend, 5 attend
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.promoAudit', '10') # multiple bet
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.rewards', '10.00') # # give money
