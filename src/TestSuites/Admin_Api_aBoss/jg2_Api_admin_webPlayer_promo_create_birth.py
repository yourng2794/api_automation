...
#         ReplaceIniValue('admin_webPlayer_promo_create', 'API.condition', '')
    ...
    def run(self, copy_result):
        ...
        promoName = IniValue('setting', 'API.promoname')+'生日'
        ...
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.promoType', '2') # 1 normal, 2 birth, 3 save, 4 friend, 5 attend
        ...
        ReplaceIniValue('admin_webPlayer_promo_create', 'API.condition', condition2) # 4 Change to birth format 當月存款金額=>currentDepositAmount,放寬天數=>relaxationDays
