...
class TestCase(BaseCase):
    ...
    def __init__(self,MyTest):
        ...
        self.CaseTitle= '[Feature] API POST partner create webmaster'
        self.CaseNote= ''
        self.TestCaseID= '168'
...
#         ReplaceIniValue('admin_partner_create', 'API.permission', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST partner create webmaster'+'\n')
        ...
        ReplaceIniValue('admin_partner_create', 'API.ptAcc', webMasterAcc)
        ReplaceIniValue('admin_partner_create', 'API.ptPwd', webMasterAcc)
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST partner create webmaster')
