...
from O2oUtility import AdminOrgEmployeeListSingle
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_org_employee_list_single', 'API.userId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_org_employee_list_single', 'API.userId', userId)
        
        self.res_log, result = AdminOrgEmployeeListSingle(self.res_log, 'Boss', userAcc, depTitleId, depId)
