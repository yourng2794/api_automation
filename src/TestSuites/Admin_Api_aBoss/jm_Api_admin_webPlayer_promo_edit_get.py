...
from O2oUtility import AdminWebPromoEditGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_promo_edit_get', 'API.promoId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result= AdminWebPromoEditGet(self.res_log, 'Boss', 1, promoName, promoId, str_conditions)
        ...
        ReplaceIniValue('admin_webPlayer_promo_edit_get', 'API.promoId', promoId2)
        
        self.res_log, result2= AdminWebPromoEditGet(self.res_log, 'Boss', 2, promoName2, promoId2, str_conditions2)
        ...
        ReplaceIniValue('admin_webPlayer_promo_edit_get', 'API.promoId', promoId3)
        
        self.res_log, result3= AdminWebPromoEditGet(self.res_log, 'Boss', 3, promoName3, promoId3, str_conditions3)
        ...
        ReplaceIniValue('admin_webPlayer_promo_edit_get', 'API.promoId', promoId4)
        
        self.res_log, result4= AdminWebPromoEditGet(self.res_log, 'Boss', 4, promoName4, promoId4, str_conditions4)
        ...
        ReplaceIniValue('admin_webPlayer_promo_edit_get', 'API.promoId', promoId5)
        
        self.res_log, result5= AdminWebPromoEditGet(self.res_log, 'Boss', 5, promoName5, promoId5, str_conditions5)
