...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_risk_edit_get', 'API.ptid', bankerId)
        ...
        self.res_log, result = AdminWebRiskEditGet(self.res_log, 'Boss', riskname, riskid, edit_count, edit_interval, edit_time, edit_type)
