...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_transfer_list_frame', 'API.bankerId', partnerid)
            ReplaceIniValue('admin_webPlayer_transfer_list_frame', 'API.vipname', vipname)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_webPlayer_transfer_list_frame', True, False)
