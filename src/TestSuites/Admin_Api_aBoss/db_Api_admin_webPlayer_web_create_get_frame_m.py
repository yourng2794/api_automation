...
from O2oUtility import AdminWebCreateGetFrame
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        webDomain = ', '.join(list_webDomain)
        bankerId = IniValue('setting', 'API.bankerId')
        ReplaceIniValue('admin_webPlayer_web_create_get_frame', 'API.bankerId', bankerId)
        
        self.res_log, result = AdminWebCreateGetFrame(self.res_log, 'Boss', webDomain, web_or_mobile = 'Mobile')
