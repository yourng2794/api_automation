...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_promo_commission_type_list_frame', 'API.bankerId', bankerId)
        ReplaceIniValue('admin_webPlayer_promo_commission_type_list_frame', 'API.page', '')
        
        self.res_log, result, commissionTypeId = AdminWebPromoCommissionTypeListFrame(self.res_log, 'Boss', commissionTypeName, 'Mobile')
