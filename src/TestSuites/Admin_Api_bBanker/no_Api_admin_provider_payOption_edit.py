...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            paymentId2 = IniValue('setting', 'API.paymentid')
            ...
            json_dict = {}
            json_dict['payOptionId'] = payOptionId2
            json_dict['bankerId'] = partnerId
            json_dict['payName'] = payOptionName2
            json_dict['currency'] = []
            json_dict['currency'] = [currency]
            json_dict['review'] = '0'
            json_dict['reviewAmount'] = ''
            json_dict['reviewHour'] = ''
            json_dict['onlinePromo'] = '3'
            json_dict['onlineCount'] = '10'
            json_dict['onlineAmount'] = '100'
            json_dict['onlineRatio'] = '1.5'
            json_dict['onlineMaxdep'] = '100000'
            json_dict['onlineMindep'] = '10'
            json_dict['onlineLimit'] = '1000'
            json_dict['companyPromo'] = '3'
            json_dict['companyCount'] = '15'
            json_dict['companyAmount'] = '50'
            json_dict['companyRatio'] = '1.6'
            json_dict['companyMaxdep'] = '1000000'
            json_dict['companyMindep'] = '10000'
            json_dict['companyLimit'] = '500'
            json_dict['withdraw'] = {}
            json_dict['deposit'] = {}
            json_dict['deposit'][currency] = []
            json_dict['withdraw'][currency] = []
            json_dict['withdraw'][currency] = [paymentId2]
            json_dict['deposit'][currency] = [paymentId2]
            with open(api_json, 'w') as outfile:
                json.dump(json_dict, outfile, indent=4, ensure_ascii=False)
                
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_provider_payOption_edit', True, False)
            ...
            result_list.append('FAIL')
            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Exception: on admin_provider_payOption_edit... %s' % str(e))
