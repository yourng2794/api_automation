...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_transfer_list_frame', 'API.webId', webId2)
            ...
            if(return_value):
                ...
                for soup_span in soup_spans:
                    if(str(soup_span.string).replace('\n','').replace(' ','') == playerAcc2):
                        ...
                        player_id2 = soup_span.get('id')
                        if(player_id2 == playerId2):
                            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get playerId2: '+player_id2)
