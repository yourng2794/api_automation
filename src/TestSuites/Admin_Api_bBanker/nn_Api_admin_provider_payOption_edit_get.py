    ...
    def run(self, copy_result):
        ...
        try:
            ...
            if(return_value):
                ...
                if(json_response['company_amount'] == 1):
                    result_list.append('PASS')
                else:
                ...
                if(json_response['company_limit'] == 5):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['company_maxdep'] == 3):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['company_mindep'] == 4):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['company_promo'] == 2):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['company_ratio'] == 2.1):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                ...
                if(json_response['online_amount'] == 4):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                ...
                if(json_response['online_limit'] == 8):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['online_maxdep'] == 6):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['online_mindep'] == 7):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['online_promo'] == 2):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['online_ratio'] == 1.1):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                ...
                if(json_response['review_amount'] == 1):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
                    
                if(json_response['review_hour'] == 2):
                    result_list.append('PASS')
                else:
                    result_list.append('FAIL')
