...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webId', '')
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webDomainId', '')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webDomainUrl', '')
    ...
    def run(self, copy_result):
        ...
        vipName2 = IniValue('setting', 'API.vipName2')+number
        webId2 = IniValue('setting', 'API.webId2')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webId', webId2)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipId', vipId2)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipname', vipName2)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.depositTimes', '')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.depositTotal', '1000')
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webDomainId', webDomainId2)
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.webDomainUrl', webDomain2)
