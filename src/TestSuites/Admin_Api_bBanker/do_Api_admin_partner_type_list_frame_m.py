...
from O2oUtility import WriteLog, WriteDebugLog, IniValue, ReplaceIniValue, AdminPartnerTypeListFrame
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, typeId = AdminPartnerTypeListFrame(self.res_log, 'Banker', typeName2, 'Mobile')
