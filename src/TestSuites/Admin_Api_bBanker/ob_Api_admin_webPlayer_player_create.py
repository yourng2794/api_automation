...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_player_create', 'API.playerAcc', playerAcc2)
            ReplaceIniValue('admin_webPlayer_player_create', 'API.playerPwd', playerAcc2)
            ReplaceIniValue('admin_webPlayer_player_create', 'API.playerName', myName)
            ReplaceIniValue('admin_webPlayer_player_create', 'API.vipId', vipId2)
            ReplaceIniValue('admin_webPlayer_player_create', 'API.webId', webId2)
