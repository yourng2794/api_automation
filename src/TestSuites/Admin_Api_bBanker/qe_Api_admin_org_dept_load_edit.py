...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_dept_load_edit', 'API.depId', depId2)
            ...
            if(return_value):
                ...
                if(json_response.get('department').get('og_name') == depname2):
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get depname2: '+depname2)
                else:
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Fail get depname2: '+json_response.get('department').get('og_name')+' != '+depname2)
