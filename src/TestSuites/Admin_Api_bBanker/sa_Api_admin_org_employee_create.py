...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_employee_create', 'API.userAcc', userAcc2)
            ReplaceIniValue('admin_org_employee_create', 'API.userPwd', userAcc2)
            ReplaceIniValue('admin_org_employee_create', 'API.depId', depId2)
            ReplaceIniValue('admin_org_employee_create', 'API.titleId', titleId2)
