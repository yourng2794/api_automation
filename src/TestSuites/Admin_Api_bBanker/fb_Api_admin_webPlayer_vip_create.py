...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST webPlayer vip create'
        self.CaseNote= ''
        self.TestCaseID= '82'
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.webId', '')
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.bankerId', '')
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.vipname', '')
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.depositTimes', '')
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.depositTotal', '')
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.webDomainId', '')
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.webDomainUrl', '')
