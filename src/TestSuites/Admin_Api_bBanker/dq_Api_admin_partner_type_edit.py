...
from O2oUtility import WriteLog, WriteDebugLog, IniValue, ReplaceIniValue, AdminPartnerTypeEdit
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_partner_type_edit', 'API.typeId', typeId2)
        ReplaceIniValue('admin_partner_type_edit', 'API.typeName', typeName2)
        ...
        self.res_log, result = AdminPartnerTypeEdit(self.res_log, 'Banker')
