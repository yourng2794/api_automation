...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_jobtitle_get', 'API.titleId', depTitleId2)
            ...
            if(return_value):
                ...
                if(json_response['dp_name'] == depTitle2):
                    ...
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Fail get depTitle2: '+json_response['dp_name']+' != '+depTitle2)
