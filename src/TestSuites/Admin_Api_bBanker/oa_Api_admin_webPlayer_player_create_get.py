...
from O2oUtility import WriteLog, IniValue
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            if(return_value):
                ...
                if(json_response['layerList'][vipId2] == vipName2):
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'Success get vipName2: '+vipName2)
                    result_list.append('PASS')
                else:
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'Fail get vipName2: '+json_response['layerList'][vipId2]+' != '+vipName2)
