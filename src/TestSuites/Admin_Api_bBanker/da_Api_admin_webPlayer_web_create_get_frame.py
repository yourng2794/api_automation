...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST admin webPlayer web create get frame'
        self.CaseNote= ''
        self.TestCaseID= '241'
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST admin webPlayer web create get frame'+'\n')
        ...
        self.res_log, result = AdminWebCreateGetFrame(self.res_log, 'Banker', webDomain2, web_or_mobile = 'Web')
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST admin webPlayer web create get frame')
