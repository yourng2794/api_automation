...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_provider_payOption_edit_layer', 'API.webId', webId2)
            ReplaceIniValue('admin_provider_payOption_edit_layer', 'API.bankerId', '')
            python_dict = {}
            python_dict[vipId2] = payOptionId2
