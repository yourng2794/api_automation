...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_player_list_frame', 'API.webId', webId2)
            ReplaceIniValue('admin_webPlayer_player_list_frame', 'API.playerAcc', playerAcc2)
            ...
            if(return_value):
                ...
                if(playerAcc2 in soup_div.text):
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get playerAcc2: '+playerAcc2)
                    playerId2 = soup_div.find("div", class_='vip-type')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get playerId2: '+playerId2.get('id'))
                    ReplaceIniValue('setting', 'API.playerid2', playerId2.get('id'))
