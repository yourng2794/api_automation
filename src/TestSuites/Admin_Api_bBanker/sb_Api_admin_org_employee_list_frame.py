...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_employee_list_frame', 'API.depId', depId2)
            ReplaceIniValue('admin_org_employee_list_frame', 'API.titleId', titleId2)
            ReplaceIniValue('admin_org_employee_list_frame', 'API.userAcc', userAcc2)
            ...
            if(return_value):
                ...
                userId2 = soup.find('a', attrs={'href':'organize_all_mem_edit.html'}).get('id')
                if(userId2):
                    result_list2.append('PASS')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get userId2: '+userId2)
                    ReplaceIniValue('setting', 'API.userid2', userId2)
                else:
