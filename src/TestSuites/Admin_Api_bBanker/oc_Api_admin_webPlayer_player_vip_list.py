...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_player_vip_list', 'API.webId', webId2)
            ...
            if(return_value):
                ...
                if(json_response.get(vipId2) == vipName2):
                    result_list.append('PASS')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get vipName2: '+vipName2)
                else:
                    result_list.append('FAIL')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Fail get vipName2: '+json_response.get(vipId2)+' != '+vipName2)
