...
from O2oUtility import WriteLog, WriteDebugLog, ReplaceIniValue, AdminPartnerTypePermissionGet
...
class TestCase(BaseCase):
    ...
    def __init__(self,MyTest):
        ...
        self.CaseTitle= '[Feature] API POST partner type permission get'
        self.CaseNote= ''
        self.TestCaseID= '249'
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST partner type permission get'+'\n')
        
        self.res_log, result, str_permission_final = AdminPartnerTypePermissionGet(self.res_log, 'Banker')
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST partner type permission get')
