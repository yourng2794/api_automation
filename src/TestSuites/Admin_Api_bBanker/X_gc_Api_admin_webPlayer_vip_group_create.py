...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_vip_group_create', 'API.vipid[]', vipId2)
            ReplaceIniValue('admin_webPlayer_vip_group_create', 'API.vipGroupName', vipGroupName2)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_webPlayer_vip_group_create', True, False)
