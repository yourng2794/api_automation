...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_jobtitle_list_frame', 'API.depId', depId2)
                ...
                for soup_li in soup_lis:
                    ...
                    for soup_div in soup_divs:
                        if(str(soup_div.string).replace('\n','').replace(' ','') == depTitle2):
                            ...
                            depTitleId2 = soup_li.find('a', attrs={'href':'organize_office_edit.html'}).get('id')
                            ReplaceIniValue('setting', 'API.depTitleId2', depTitleId2)
