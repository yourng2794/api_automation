...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST admin webPlayer web edit'
        self.CaseNote= ''
        self.TestCaseID= '247'
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST admin webPlayer web edit'+'\n')
        ...
        ReplaceIniValue('admin_webPlayer_web_edit', 'API.use', '2')
        python_dict = {}
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST admin webPlayer web edit')
