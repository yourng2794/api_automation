...
from O2oUtility import WriteLog, WriteDebugLog, IniValue, AdminProfile
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        current_user = IniValue('setting', 'API.bankeracc')+number
        self.res_log, result = AdminProfile(self.res_log, 'Banker', current_user)
