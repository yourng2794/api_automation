...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_provider_bankCard_create', 'API.bankName', bankname2)
            ReplaceIniValue('admin_provider_bankCard_create', 'API.branchName', branchname2)
            ReplaceIniValue('admin_provider_bankCard_create', 'API.bankAcc', bankacc2)
            ReplaceIniValue('admin_provider_bankCard_create', 'API.accName', accname2)
            ReplaceIniValue('admin_provider_bankCard_create', 'API.currency', currency)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_provider_bankCard_create', True, False)
