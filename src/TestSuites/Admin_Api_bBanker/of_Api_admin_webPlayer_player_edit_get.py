...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_player_edit_get', 'API.playerId', playerId2)
            ...
            if(return_value):
                ...
                if(json_response['vip_id'] == vipId2):
                    result_list.append('PASS')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get vipId2: '+vipId2)
                else:
                    result_list.append('FAIL')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Fail get vipId2: '+json_response['vip_id']+' != '+vipId2)
                
                if(json_response['web_id'] == webId2):
                    result_list.append('PASS')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get webId2: '+webId2)
                else:
                    result_list.append('FAIL')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Fail get webId2: '+json_response['web_id']+' != '+webId2)
