...
from O2oUtility import WriteLog, WriteDebugLog, ReplaceIniValue, IniValue, AdminPartnerPermissionGet
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, str_currency, str_permission_final, typeId = AdminPartnerPermissionGet(self.res_log, 'Banker', webId2, typename2)
