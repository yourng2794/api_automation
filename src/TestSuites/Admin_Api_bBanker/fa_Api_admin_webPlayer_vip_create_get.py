...
from O2oUtility import WriteLog, WriteDebugLog, IniValue, ReplaceIniValue, AdminVipCreateGet
...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[Feature] API POST webPlayer vip create get'
        self.CaseNote= ''
        self.TestCaseID= '385'
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_create_get', 'API.webId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer vip create get'+'\n')
        ...
        ReplaceIniValue('admin_webPlayer_vip_create_get', 'API.webId', webId2)
        self.res_log, result = AdminVipCreateGet(self.res_log, 'Banker', webName2, webDomain2, webDomainId2)
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST webPlayer vip create get')
