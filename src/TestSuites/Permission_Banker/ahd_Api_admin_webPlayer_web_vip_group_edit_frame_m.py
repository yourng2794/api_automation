...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminWebVipGroupEditFrame(self.res_log, 'Banker', vipId, vipName, webDomain, 'Mobile')
        ...
        self.res_log, result = AdminWebVipDomainEdit(self.res_log, 'Banker')
