...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_create_get_frame', 'API.bankerId', partnerId)
        
        self.res_log, result = AdminWebCreateGetFrame(self.res_log, 'Banker', webDomain, webDomainId, 'Mobile')
