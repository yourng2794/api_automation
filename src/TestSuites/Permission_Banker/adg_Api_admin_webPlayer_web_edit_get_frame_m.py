...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_edit_get_frame', 'API.bankerId', partnerId)
        
        self.res_log, result = AdminWebEditGetFrame(self.res_log, 'Banker', webDomain, webDomainId, 'Mobile')
