...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_delete', 'API.bankerId', '')
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, vipId = AdminVipListFrame(self.res_log, 'Banker', vipname, 'Web')
        if(result == True):
            result_list.append('PASS')
        else:
            result_list.append('FAIL')
        ...
        self.res_log, result, vipId2 = AdminVipListFrame(self.res_log, 'Banker', vipname, 'Mobile')
        ...
        # Part 4: Delete VIP.
        ReplaceIniValue('admin_webPlayer_vip_delete', 'API.bankerId', partnerid)
...
#         ReplaceIniValue('admin_webPlayer_vip_list_frame', 'API.bankerId', partnerid)
#         self.res_log, result, vipId3 = AdminVipListFrame(self.res_log, 'Banker', vipname, 'Web')
#         
#         if(result == True):
#             result_list.append('PASS')
#         else:
