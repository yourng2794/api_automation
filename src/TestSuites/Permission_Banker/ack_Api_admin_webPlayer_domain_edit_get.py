...
from O2oUtility import AdminDomainEditGet
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_edit_get', 'API.webDomainId', webDomainId)
        ReplaceIniValue('admin_webPlayer_domain_edit_get', 'API.bankerId', partnerId)
