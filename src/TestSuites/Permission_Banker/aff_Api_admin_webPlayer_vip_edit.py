...
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.bankerId', '')
...
#         ReplaceIniValue('admin_webPlayer_vip_edit', 'API.withdrawalTotal', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit', 'API.bankerId', partnerid)
        ...
        self.res_log, result = AdminVipEdit(self.res_log, 'Banker')
