...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminProviderPayOptionEditGetWithdraw(self.res_log, 'Banker', paymentName, withdrawId)
        ...
        self.res_log, result = AdminProviderPayOptionEditGetWithdraw(self.res_log, 'Banker', paymentName, depositId)
