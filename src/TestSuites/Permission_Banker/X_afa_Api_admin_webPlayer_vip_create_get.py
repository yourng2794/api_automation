...
from O2oUtility import AdminVipCreateGet
...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_create_get', 'API.bankerId', '')
    ...
    def run(self, copy_result):
        ...
        acc = IniValue('setting', 'API.bankeracc')
        ReplaceIniValue('admin_webPlayer_vip_create_get', 'API.bankerId', partnerId)
        
        self.res_log, result = AdminVipCreateGet(self.res_log, 'Banker', partnerId, acc)
