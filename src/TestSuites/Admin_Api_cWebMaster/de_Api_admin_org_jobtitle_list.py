...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_jobtitle_list', 'API.depId', agent_level4_dept_id)
                ...
                for each_element in list(json_list):
                    if(each_element['dp_name'] == agent_level4_dept_title):
                        ...
                        if(each_element['dp_sid'] == agent_level4_dept_title_id):
                            ...
                            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Fail get depTitleId: '+each_element['dp_sid']+' != '+agent_level4_dept_title_id)
