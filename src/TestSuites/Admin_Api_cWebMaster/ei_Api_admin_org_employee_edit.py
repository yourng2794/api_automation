...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_employee_edit', 'API.userId', agent_level4_dept_employee_id)
            ReplaceIniValue('admin_org_employee_edit', 'API.userNote', 'After Edit')
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_org_employee_edit', True, False)
            ...
            result_list.append('FAIL')
            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Exception: on admin_org_employee_edit... %s' % str(e))
