...
class TestCase(BaseCase):
    ...
    def __init__(self,MyTest):
        ...
        self.CaseTitle= '[Feature] API POST partner create agent level 4 agent level 4'
        self.CaseNote= ''
        self.TestCaseID= '387'
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST partner create agent level 4'+'\n')
        ...
        ReplaceIniValue('admin_partner_create', 'API.ptAcc', agent_level4)
        ReplaceIniValue('admin_partner_create', 'API.ptPwd', agent_level4)
        ReplaceIniValue('admin_partner_create', 'API.ptTypeId', web_master_id)
        ...
        self.res_log, result = AdminPartnerCreate(self.res_log, 'WebMaster', myname, agent_level4, '', web_master_id, webId)
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [Feature] API POST partner create agent level 4')
