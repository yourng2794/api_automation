...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_player_list_frame', 'API.playerAcc', webmaster_member_name)
            ...
            if(return_value):
                ...
                if(webmaster_member_name in soup_div.text):
                    ...
                    ReplaceIniValue('setting', 'API.webmaster_member_id', playerId.get('id'))
