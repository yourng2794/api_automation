...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST web domain edit get'
        self.CaseNote= ''
        self.TestCaseID= '431'
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_edit_get', 'API.bankerId', web_master_id)
        
        self.res_log, result = AdminDomainEditGet(self.res_log, 'WebMaster', '')
