...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_employee_create', 'API.userAcc', agent_level4_dept_employee)
            ReplaceIniValue('admin_org_employee_create', 'API.userPwd', agent_level4_dept_employee)
            ReplaceIniValue('admin_org_employee_create', 'API.depId', agent_level4_dept_id)
            ReplaceIniValue('admin_org_employee_create', 'API.titleId', agent_level4_dept_title_id)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_org_employee_create', True, False)
            ...
            result_list.append('FAIL')
            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Exception: on admin_org_employee_create... %s' % str(e))
