...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST webPlayer domain delete'
        self.CaseNote= ''
        self.TestCaseID= '432'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_webPlayer_domain_delete', False, False)
