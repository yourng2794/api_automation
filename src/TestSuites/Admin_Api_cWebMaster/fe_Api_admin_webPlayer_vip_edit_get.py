...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_vip_edit_get', 'API.bankerId', web_master_id)
            ReplaceIniValue('admin_webPlayer_vip_edit_get', 'API.vipId', vipid)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_webPlayer_vip_edit_get', False, False)
            ...
            if(return_value):
                ...
                if('pt_id' in response_data):
                    result_list2.append('PASS')
                    self.res_log = WriteDebugLog(self.res_log, print_tab+'- Success get: pt_id.')
                else:
            ...
            result_list.append('FAIL')
            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Exception: on admin_webPlayer_vip_edit_get... %s' % str(e))
