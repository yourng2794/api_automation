...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_list_frame', 'API.bankerid', web_master_id)
        webId = IniValue('setting', 'API.webId')
        webName = IniValue('setting', 'API.webName')
        
        self.res_log, result, webdomainid = AdminDomainListFrame(self.res_log, 'WebMaster', webName, webId, 'Mobile')
