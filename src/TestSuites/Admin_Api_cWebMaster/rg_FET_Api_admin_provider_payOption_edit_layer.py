...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST provider payOption edit layer'
        self.CaseNote= ''
        self.TestCaseID= '524'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_provider_payOption_edit_layer', 'API.bankerId', web_master_id)
            python_dict = {}
            python_dict[vipId] = payOptionId
            ReplaceIniValue('admin_provider_payOption_edit_layer', 'API.layerPay', str(python_dict).replace("'",'"').replace(' ',''))
            
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_provider_payOption_edit_layer', False, False)
