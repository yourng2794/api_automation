...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST webPlayer domain create'
        self.CaseNote= ''
        self.TestCaseID= '426'
    ...
    def run(self, copy_result):
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\tStart >>'+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [FET] API POST webPlayer domain create'+'\n')
        ...
        self.res_log, result = AdminDomainCreate(self.res_log, 'WebMaster', web_or_mobile = 'Web')
...
#         WriteLog('\t'+'Test Result: ' + self.TestResult)
        ...
        self.res_log = WriteDebugLog(self.res_log, '\n\n\tEnd << '+datetime.today().strftime("%m月%d日%H時%M分%S秒")+' [FET] API POST webPlayer domain create')
