...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST provider payOption edit get quick layer frame'
        self.CaseNote= ''
        self.TestCaseID= '522'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_provider_payOption_edit_get_quick_layer_frame', 'API.bankerId', web_master_id)
