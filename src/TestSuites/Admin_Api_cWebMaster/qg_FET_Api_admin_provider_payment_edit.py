...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST provider payment edit'
        self.CaseNote= ''
        self.TestCaseID= '516'
    ...
    def run(self, copy_result):
        ...
        print_tab = '\n\t\t'
        try:
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_provider_payment_edit', False, False)
