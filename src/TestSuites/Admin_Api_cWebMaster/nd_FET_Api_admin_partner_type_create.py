...
class TestCase(BaseCase):
    ...
    def __init__(self,MyTest):
        ...
        self.CaseTitle= '[FET] API POST partner type create'
        self.CaseNote= ''
        self.TestCaseID= '443'
    ...
    def run(self, copy_result):
        ...
        typeName = IniValue('setting', 'API.typename')
        ReplaceIniValue('admin_partner_type_create', 'API.typeName', typeName)
        
        self.res_log, result = AdminPartnerTypeCreate(self.res_log, 'WebMaster')
