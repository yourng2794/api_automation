...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_org_jobtitle_create', 'API.depId', agent_level4_dept_id)
            ReplaceIniValue('admin_org_jobtitle_create', 'API.title', agent_level4_dept_title)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_org_jobtitle_create', True, False)
            ...
            result_list.append('FAIL')
            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Exception: on admin_org_jobtitle_create... %s' % str(e))
