...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST admin webPlayer web create get frame'
        self.CaseNote= ''
        self.TestCaseID= '434'
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminWebCreateGetFrame(self.res_log, 'WebMaster', webDomain, web_master_id, web_or_mobile = 'Web')
