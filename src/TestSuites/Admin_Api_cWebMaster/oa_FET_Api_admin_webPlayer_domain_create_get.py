...
from O2oUtility import AdminDomainCreateGet
...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST webPlayer domain create get'
        self.CaseNote= ''
        self.TestCaseID= '429'
    ...
    def run(self, copy_result):
        ...
        bankerAcc = IniValue('setting', 'API.acc')
        ReplaceIniValue('admin_webPlayer_domain_create_get', 'API.bankerId', web_master_id)
        ...
        self.res_log, result = AdminDomainCreateGet(self.res_log, 'WebMaster')
