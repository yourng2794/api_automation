...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST provider payOption edit get layer frame m'
        self.CaseNote= ''
        self.TestCaseID= '528'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_provider_payOption_edit_get_layer_frame', 'API.webId', webId)
            ReplaceIniValue('admin_provider_payOption_edit_get_layer_frame', 'API.payOptionId', payOptionId)
            ReplaceIniValue('admin_provider_payOption_edit_get_layer_frame', 'API.bankerId', web_master_id)
