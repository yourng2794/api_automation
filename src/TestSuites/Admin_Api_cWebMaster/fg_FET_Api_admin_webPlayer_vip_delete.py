...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST webPlayer vip delete'
        self.CaseNote= ''
        self.TestCaseID= '464'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_vip_delete', 'API.bankerId', web_master_id)
            ReplaceIniValue('admin_webPlayer_vip_delete', 'API.vipId', vipid)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_webPlayer_vip_delete', False, False)
            ...
            result_list.append('FAIL')
            self.res_log = WriteDebugLog(self.res_log, print_tab+'- Exception: on admin_webPlayer_vip_delete... %s' % str(e))
