...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST admin webPlayer web create get frame m'
        self.CaseNote= ''
        self.TestCaseID= '435'
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_create_get_frame', 'API.bankerId', web_master_id)
        ReplaceIniValue('admin_webPlayer_web_create_get_frame', 'API.webId', webId)
        
        self.res_log, result = AdminWebCreateGetFrame(self.res_log, 'WebMaster', webDomain, web_master_id, web_or_mobile = 'Mobile')
