...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST webPlayer vip edit'
        self.CaseNote= ''
        self.TestCaseID= '463'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_webPlayer_vip_edit', 'API.bankerId', web_master_id)
            ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipname', vipname)
            ReplaceIniValue('admin_webPlayer_vip_edit', 'API.vipId', vipid)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_webPlayer_vip_edit', False, False)
