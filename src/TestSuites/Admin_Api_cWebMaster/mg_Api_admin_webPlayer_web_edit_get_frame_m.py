...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_edit_get_frame', 'API.bankerId', web_master_id)
        
        self.res_log, result = AdminWebEditGetFrame(self.res_log, 'WebMaster', webDomain, webDomainId, web_or_mobile = 'Mobile')
