...
class TestCase(BaseCase):
    ...
    def __init__(self,MyTest):
        ...
        self.CaseTitle= '[Feature] API POST partner create agent level 5'
        self.CaseNote= ''
        self.TestCaseID= '423'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            ReplaceIniValue('admin_partner_create', 'API.ptAcc', agent_level5)
            ReplaceIniValue('admin_partner_create', 'API.ptPwd', agent_level5)
            ReplaceIniValue('admin_partner_create', 'API.ptParentId', agent_id_level4)
            ReplaceIniValue('admin_partner_create', 'API.website[]', webId)
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_partner_create', True, False)
