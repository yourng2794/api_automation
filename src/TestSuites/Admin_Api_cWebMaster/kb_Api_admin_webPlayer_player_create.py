...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            player_withdraw = IniValue('setting', 'API.player_withdraw')
            ReplaceIniValue('admin_webPlayer_player_create', 'API.playerAcc', webmaster_member_name)
            ReplaceIniValue('admin_webPlayer_player_create', 'API.playerPwd', webmaster_member_name)
            ...
            ReplaceIniValue('admin_webPlayer_player_create', 'API.pwdWithdraw', player_withdraw)
