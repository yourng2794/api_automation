...
class TestCase(BaseCase):
    ...
    def __init__(self, MyTest):
        ...
        self.CaseTitle= '[FET] API POST provider bankCard edit'
        self.CaseNote= ''
        self.TestCaseID= '509'
    ...
    def run(self, copy_result):
        ...
        try:
            ...
            accname = IniValue('setting', 'API.accname')
            ...
            ReplaceIniValue('admin_provider_bankCard_edit', 'API.accName', accname)
            ...
            return_value, response_time, response_data, self.res_log = ApiResponse(print_tab, self.res_log, 'admin_provider_bankCard_edit', False, False)
