...
from O2oUtility import AdminProfile
...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        current_user = IniValue('setting', 'TestData.admin_boss_id')
        
        self.res_log, result = AdminProfile(self.res_log, 'Boss', current_user)
