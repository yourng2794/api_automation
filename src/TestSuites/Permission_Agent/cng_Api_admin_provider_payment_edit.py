...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result, pay_type_id, paymentUrl, paymentEnable = AdminProviderPaymentEditInfoGet(self.res_log, 'Agent', paymentName, paymentId, payTypeName)
        ...
        self.res_log, result, edit_currency = AdminProviderPaymentEditCurrencyGet(self.res_log, 'Agent')
        ...
        self.res_log, result = AdminProviderPaymentEdit(self.res_log, 'Agent')
