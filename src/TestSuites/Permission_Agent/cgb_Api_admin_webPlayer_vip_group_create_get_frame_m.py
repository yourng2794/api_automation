...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create_get_frame', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create_get_frame', 'API.AgentId', partnerid)
        
        self.res_log, result = AdminVipGroupCreateGetFrame(self.res_log, 'Agent', vipName, vipId, 'Mobile')
