...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_delete', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        vipname = 'DeleteVIP'
        ReplaceIniValue('admin_webPlayer_vip_create', 'API.AgentId', partnerid)
        ...
        self.res_log, result = AdminVipCreate(self.res_log, 'Agent')
        ...
        ReplaceIniValue('admin_webPlayer_vip_list_frame', 'API.AgentId', partnerid)
        
        self.res_log, result, vipId = AdminVipListFrame(self.res_log, 'Agent', vipname, 'Web')
        if(result == True):
            result_list.append('PASS')
        else:
            result_list.append('FAIL')
        ...
        self.res_log, result, vipId2 = AdminVipListFrame(self.res_log, 'Agent', vipname, 'Mobile')
        ...
        # Part 4: Delete VIP.
        ReplaceIniValue('admin_webPlayer_vip_delete', 'API.AgentId', partnerid)
        ReplaceIniValue('admin_webPlayer_vip_delete', 'API.vipId', vipId)
        self.res_log, result = AdminVipDelete(self.res_log, 'Agent')
...
#         ReplaceIniValue('admin_webPlayer_vip_list_frame', 'API.AgentId', partnerid)
#         self.res_log, result, vipId3 = AdminVipListFrame(self.res_log, 'Agent', vipname, 'Web')
#         
#         if(result == True):
#             result_list.append('PASS')
#         else:
