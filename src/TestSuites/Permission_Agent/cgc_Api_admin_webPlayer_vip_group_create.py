...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_create', 'API.AgentId', partnerId)
        ...
        self.res_log, result = AdminVipGroupCreate(self.res_log, 'Agent')
