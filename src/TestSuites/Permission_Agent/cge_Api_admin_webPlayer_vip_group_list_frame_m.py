...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_list_frame', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_group_list_frame', 'API.AgentId', partnerid)
        
        self.res_log, result, vipGroupId = AdminVipGroupListFrame(self.res_log, 'Agent', vipGroupName, 'Mobile')
