...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_list_frame', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_list_frame', 'API.AgentId', partnerId)
        
        self.res_log, result, webId = AdminWebListFrame(self.res_log, 'Agent', webName, 'Mobile')
