...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit_get', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_vip_edit_get', 'API.AgentId', partnerid)
        ReplaceIniValue('admin_webPlayer_vip_edit_get', 'API.vipId', vipid)
        
        self.res_log, result = AdminVipEditGet(self.res_log, 'Agent')
