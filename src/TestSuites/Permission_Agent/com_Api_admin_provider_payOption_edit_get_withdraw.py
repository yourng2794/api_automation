...
class TestCase(BaseCase):
    ...
    def run(self, copy_result):
        ...
        self.res_log, result = AdminProviderPayOptionEditGetWithdraw(self.res_log, 'Agent', paymentName, withdrawId)
        ...
        self.res_log, result = AdminProviderPayOptionEditGetWithdraw(self.res_log, 'Agent', paymentName, depositId)
