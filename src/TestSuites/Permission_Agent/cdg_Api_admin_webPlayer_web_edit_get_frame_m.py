...
class TestCase(BaseCase):
    ...
    def teardown(self):
        ...
        ReplaceIniValue('admin_webPlayer_web_edit_get_frame', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_web_edit_get_frame', 'API.AgentId', partnerId)
        
        self.res_log, result = AdminWebEditGetFrame(self.res_log, 'Agent', webDomain, webDomainId, 'Mobile')
