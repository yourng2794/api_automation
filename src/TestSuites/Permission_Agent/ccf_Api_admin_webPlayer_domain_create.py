...
#         ReplaceIniValue('admin_webPlayer_domain_create', 'API.AgentId', '')
    ...
    def run(self, copy_result):
        ...
        ReplaceIniValue('admin_webPlayer_domain_create', 'API.AgentId', partnerId)
        self.res_log, result = AdminDomainCreate(self.res_log, 'Agent', webDomain)
